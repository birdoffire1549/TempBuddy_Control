    ...
    */
    const char PROGMEM ADMIN_SETTINGS_PAGE[] = {""  
        "<form name=\"settings\" method=\"post\" id=\"settings\" action=\"admin\"> "
            ...
            "<h2>Device</h2>"
            "<table>"
                "<tr><td>Hostname:</td><td><input maxlength=\"63\" type=\"text\" value=\"${hostname}\" name=\"hostname\" id=\"hostname\"></td></tr> "
            "</table>"
            "<h2>WiFi</h2> "
            "<p>Note: Leave these settings at 'SET_ME' to keep device in AP Mode.</p>"
            "<table>"
            ...
            "</table>"
            "<h2>AP WiFi</h2>"
            "<p>Note: AP Mode is disabled when device connects to external network.</p>"
            "<table>"
                "<tr><td>AP SSID:</td><td><input maxlength=\"32\" type=\"text\" value=\"${apssid}\" name=\"apssid\" id=\"apssid\"></td></tr> "
                "<tr><td>AP Password:</td><td><input maxlength=\"63\" type=\"text\" value=\"${appwd}\" name=\"appwd\" id=\"appwd\"></td></tr> "
                "<tr><td>AP's IP:</td><td><input maxlength=\"15\" type=\"text\" value=\"${apnetip}\" name=\"apnetip\" id=\"apnetip\"></td></tr> "
                "<tr><td>Subnet Mask:</td><td><input maxlength=\"15\" type=\"text\" value=\"${apsubnet}\" name=\"apsubnet\" id=\"apsubnet\"></td></tr> "
                "<tr><td>Gateway:</td><td><input maxlength=\"15\" type=\"text\" value=\"${apgateway}\" name=\"apgateway\" id=\"apgateway\"></td></tr> "
            "</table>"
            "<h2>Application</h2> "
            "<table>"
